...
::: callout-important
### Interactive Demo
This project includes an interactive Streamlit application  
where users can input a seller ID and compare FCFS, SPT, and EDD results.

👉 [Launch App](https://scheduling-or.streamlit.app)
:::
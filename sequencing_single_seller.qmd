...
### [**4.1.1. Import Important Libraries and Load Data**]{style="color:#990000;"}
...
### [**4.1.2. Features Understanding**]{style="color:#990000;"}
...
top_three_sellers = ["6560211a19b47992c3666cc44a7e94c0","4a3ca9315b744ce9f8e9374361493884", "1f50f920176fa81dab994f9023523100"]
```
...
for seller_id in top_three_sellers:
    schedule = create_scheduling_table(seller_id, order_items, orders)
